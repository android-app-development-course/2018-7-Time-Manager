...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    public ListViewAdapter2(Context context, List<Map<String, Object>> data){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        zujian.info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String gg=(String)data.get(position).get("info");
                Intent intent=new Intent(context,Main7Activity.class);
                Bundle bundle=new Bundle();
                bundle.putString("key",gg);
