...
public class CountDownProgressBar extends View {
    ...
    private int[] colorArray = new int[]{Color.parseColor("#FF769AE7"),

            Color.parseColor("#FF1D48D4"), Color.parseColor("#FF171946")};
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.CountDownProgressBar_countDown_firstColor:
                    ...
                    firstColor = ta.getColor(attr, Color.WHITE); // 默认底色为亮灰色

                    break;

                case R.styleable.CountDownProgressBar_countDown_secondColor:

                    secondColor = ta.getColor(attr, Color.RED); // 默认进度条颜色为蓝色
                ...
                case R.styleable.CountDownProgressBar_countDown_circleWidth:
                    ...
                    circleWidth = ta.getDimensionPixelSize(attr, (int) dip2px(12f)); // 默认圆弧宽度为6dp
